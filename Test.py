...
def test_bulk_insert(df):
    ...
    duck_conn.execute('CREATE TABLE vectors(id UINTEGER, embedding FLOAT[128])')
...
def test_knn_throughput(q_vector):
    ...
    def run_query_in_thread(query_vec):
        ...
        thread_conn = duckdb.connect(DB_FILE)
...
def main():
    ...
    for n in SIZES:
        ...
        query_vector = df['embedding'].iloc[np.random.randint(0, n)]
